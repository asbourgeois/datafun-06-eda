...
[![Docs Deploy](https://github.com/asbourgeois/datafun-06-eda/actions/workflows/deploy-mkdocs.yml/badge.svg?branch=main)](https://github.com/denisecase/datafun-06-eda/actions/workflows/deploy-mkdocs.yml)
[![CI](https://github.com/asbourgeois/datafun-06-eda/actions/workflows/ci-basic-mkdocs.yml/badge.svg?branch=main)](https://github.com/asbourgeois/datafun-06-eda/actions/workflows/ci-basic-mkdocs.yml)
[![Docs](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://asbourgeois.github.io/datafun-06-eda/)
...
3. Clone to local: Open a **machine terminal** in your **`Repos`** folder and clone your new repo.
  ...
  ```shell
  git clone https://github.com/asbourgeois/datafun-06-eda
  ```
...
VS Code should have only this project (datafun-06-eda) open.
